package ru.baccasoft.zadachnik.icons.additions.additions3
...
import ru.baccasoft.zadachnik.icons.additions.Additions3

public val Additions3.MicLight: ImageVector
    get() {
        if (_micLight != null) {
            return _micLight!!
        }
        _micLight = Builder(name = "MicLight", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
                viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF040404)),
